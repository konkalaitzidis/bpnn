...
def save_training_info(model, history, video_name, comment, experiment_ID, save_dir):
    # Set the model name
    ...
    with open(os.path.join(save_dir, str(model_name)+'-training_history.csv'), 'a', newline='') as f:
        writer = csv.writer(f)
